window.addEventListener("DOMContentLoaded", () => {
  ...
  const dataProduct = [
    {
      image: "orek_tempe.jpeg",
      name: "Orek Tempe",
      price: "Rp. 8000",
      description:
        "Orek tempe, hidangan sederhana yang kaya akan rasa, menyajikan potongan tempe yang digoreng dengan rempah-rempah dan bumbu lezat. Tekstur tempe yang kenyal dan cita rasa yang gurih memberikan sentuhan khas pada masakan ini.",
    },
    {
      image: "perkedel.jpeg",
      name: "Perkedel Telur",
      price: "Rp. 6000",
      description:
        "Perkedel, camilan tradisional yang lezat, menggoda dengan kelezatan kentang yang diolah menjadi bola kecil dan digoreng hingga keemasan. Dengan lapisan luar yang renyah dan isi yang lembut, perkedel menyajikan pengalaman rasa yang memuaskan.",
    },
    {
      image: "kikil.jpeg",
      name: "Semur Kikil",
      price: "Rp. 6000",
      description:
        "Semur kikil, hidangan yang kaya cita rasa, menghadirkan potongan kikil yang empuk dan lezat dalam saus yang melimpah. Dipadu dengan rempah-rempah, semur kikil menghasilkan kombinasi nikmat antara tekstur kenyal dan rasa gurih yang menggugah selera.",
    },
    {
      image: "kentang.jpeg",
      name: "Kentang Musthofa",
      price: "Rp. 5000",
      description:
        "Kentang Musthofa, hidangan inovatif yang menggoda selera, menghadirkan potongan kentang yang renyah dilumuri bumbu khas. Dipanggang hingga kecokelatan, kentang ini mempersembahkan cita rasa yang unik dan memuaskan. ",
    },
    {
      image: "telur.jpeg",
      name: "Telur Balado",
      price: "Rp. 5000",
      description:
        "Telur balado, hidangan yang menggoda selera, menyuguhkan telur yang dimasak dengan sempurna bersama saus balado pedas yang menggigit. Kombinasi tekstur lembut telur dan kepedasan saus menciptakan harmoni cita rasa yang memikat.",
    },
    {
      image: "ayam.jpeg",
      name: "Ayam Goreng",
      price: "Rp. 9000",
      description:
        "Ayam goreng, hidangan klasik yang tak lekang oleh waktu, memikat selera dengan kulit renyah yang garing dan dagingnya yang juicy. Dipadu dengan rempah-rempah khas, ayam ini memberikan sentuhan kaya rasa yang membuatnya tak terlupakan.",
    },
  ];
  /* ========== DATA PRODUCT END ========== */
  ...
  function renderElementProduct({ image, name, price, description }) {
    return `
      <div class="card">
        ...
        <p>${description}</p>
        <button type="button" class="button button-cart">Tambahin Ke Keranjang</button>
      </div>
    `;
  }
